...
--
-- Usage (from inside musuq-postgres container):
...
COMMENT ON COLUMN companies_raw.logo_bucket_url IS 'URL pública del logo en Oracle Object Storage bucket';
